...
<!--this is updated code of single file with dynamic slider  -->
...
<div class="slider_second_description_box">
   ...
   <p><span>Category:</span> 
        ...
        <?php
        // Fetch the categories assigned to the current post
        $categories = get_the_terms(get_the_ID(), 'properties_category');
        if (!empty($categories) && !is_wp_error($categories)) {
            foreach ($categories as $category) {
                // echo '<a class="category_css" href="' . esc_url(get_term_link($category)) . '">' . esc_html($category->name) . '</a> ';
                echo '<span  class="category_css" >' . esc_html($category->name) . '</span> ';
                
                // echo esc_html($category->name) ;

            }
        } else {
            echo 'No Categories'; // Fallback message if no categories are assigned
        }
        ?>
    </p>
...
//this is old code of single property showing in property listing 
